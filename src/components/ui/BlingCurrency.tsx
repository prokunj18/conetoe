...
export const BlingCurrency = () => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex items-center gap-2 bg-card/80 backdrop-blur-sm border border-primary/30 rounded-full px-3 py-1.5 hover:border-primary/50 transition-all duration-200">
