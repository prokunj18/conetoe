...
import { ArrowLeft, RotateCcw, Zap, Crown, Trophy, Sparkles, Grid3X3 } from "lucide-react";
...
export const ClassicGameBoard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-4 animate-fade-in relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto space-y-6 relative z-10">
        ...
        {/* Game Board */}
        <Card className="p-8 bg-gradient-to-br from-slate-800/80 via-slate-900/90 to-black/80 border-2 border-slate-600/50 backdrop-blur-xl shadow-[0_0_50px_rgba(100,200,255,0.1)] animate-scale-in">
