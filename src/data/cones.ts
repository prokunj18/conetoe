...
export const CONES: ConeData[] = [
  ...
  // MYTHIC (7 items)
  { id: "galaxy", name: "Galaxy", rarity: "mythic", gradient: "bg-gradient-to-br from-purple-500 to-pink-600", preview: "linear-gradient(135deg, #a855f7, #db2777)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "rainbow", name: "Rainbow", rarity: "mythic", gradient: "bg-gradient-to-br from-red-500 via-yellow-500 via-green-500 to-blue-500", preview: "linear-gradient(135deg, #ef4444, #eab308, #22c55e, #3b82f6)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "celestial", name: "Celestial", rarity: "mythic", gradient: "bg-gradient-to-br from-indigo-400 via-purple-500 to-pink-600", preview: "linear-gradient(135deg, #818cf8, #a855f7, #db2777)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "inferno", name: "Inferno", rarity: "mythic", gradient: "bg-gradient-to-br from-yellow-400 via-red-600 to-black", preview: "linear-gradient(135deg, #facc15, #dc2626, #000000)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "void", name: "Void", rarity: "mythic", gradient: "bg-gradient-to-br from-purple-950 via-black to-indigo-950", preview: "linear-gradient(135deg, #2e1065, #000000, #1e1b4b)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "aurora", name: "Aurora", rarity: "mythic", gradient: "bg-gradient-to-br from-green-300 via-cyan-400 to-purple-500", preview: "linear-gradient(135deg, #86efac, #22d3ee, #a855f7)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },
  { id: "phoenix", name: "Phoenix", rarity: "mythic", gradient: "bg-gradient-to-br from-orange-400 via-red-600 to-pink-700", preview: "linear-gradient(135deg, #fb923c, #dc2626, #be185d)", effect: "animate-pulse hover:rotate-12 hover:scale-110" },

  // LEGENDARY (5 items)
  { id: "cosmic", name: "Cosmic Nova", rarity: "legendary", gradient: "bg-gradient-to-br from-purple-400 via-pink-500 via-orange-400 to-yellow-500", preview: "linear-gradient(135deg, #c084fc, #ec4899, #fb923c, #eab308)", effect: "animate-spin-slow hover:rotate-180 hover:scale-125 shadow-[0_0_30px_rgba(236,72,153,0.8)]" },
  { id: "prismatic", name: "Prismatic", rarity: "legendary", gradient: "bg-gradient-to-br from-red-400 via-yellow-300 via-green-400 via-blue-500 to-purple-600", preview: "linear-gradient(135deg, #f87171, #fde047, #4ade80, #3b82f6, #9333ea)", effect: "animate-pulse hover:rotate-180 hover:scale-125 shadow-[0_0_30px_rgba(59,130,246,0.8)]" },
  { id: "eternal", name: "Eternal Flame", rarity: "legendary", gradient: "bg-gradient-to-br from-white via-yellow-300 via-orange-500 to-red-800", preview: "linear-gradient(135deg, #ffffff, #fde047, #f97316, #991b1b)", effect: "animate-bounce hover:rotate-180 hover:scale-125 shadow-[0_0_40px_rgba(255,255,255,1)]" },
  { id: "divine", name: "Divine Light", rarity: "legendary", gradient: "bg-gradient-to-br from-white via-cyan-300 via-blue-400 to-indigo-600", preview: "linear-gradient(135deg, #ffffff, #67e8f9, #60a5fa, #4f46e5)", effect: "animate-spin-slow hover:rotate-180 hover:scale-125 shadow-[0_0_30px_rgba(79,70,229,0.8)]" },
  { id: "chaos", name: "Chaos Storm", rarity: "legendary", gradient: "bg-gradient-to-br from-black via-purple-600 via-pink-500 to-red-600", preview: "linear-gradient(135deg, #000000, #9333ea, #ec4899, #dc2626)", effect: "animate-pulse hover:rotate-180 hover:scale-125 shadow-[0_0_30px_rgba(147,51,234,0.8)]" },
];